...
import { resolveSafeDataDir } from "@/lib/safeDataDir.js";
...
function getUserDataDir() {
  ...
  return resolveSafeDataDir({ appName: getAppName() });
}
...
const defaultData = {
  ...
  settings: {
    ...
    contextCompactionTargetInputTokens: 20000,
    contextCompactionReserveOutputTokens: 4000,
    contextCompactionMinMessages: 12,
    contextCompactionKeepRecentMessages: 8,
    contextCompactionStablePrefixMessages: 4,
