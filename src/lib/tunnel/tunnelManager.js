...
const WORKER_URL = process.env.TUNNEL_WORKER_URL || "https://localllm.com";
const MACHINE_ID_SALT = "localllm-tunnel-salt";
...
export async function enableTunnel(localPort = 20128) {
  ...
  const publicUrl = `https://r${shortId}.localllm.com`;
...
export async function getTunnelStatus() {
  ...
  const publicUrl = shortId ? `https://r${shortId}.localllm.com` : "";
