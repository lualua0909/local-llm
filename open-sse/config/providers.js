...
export const PROVIDERS = {
  ...
  qwen: {
    ...
    format: "openai",
    clientId: env("QWEN_OAUTH_CLIENT_ID", "f0304373b74a44d2b584a3fb70ca9e56"),
  ...
  iflow: {
    ...
    clientId: env("IFLOW_OAUTH_CLIENT_ID"),
    clientSecret: env("IFLOW_OAUTH_CLIENT_SECRET"),
  ...
  qoder: {
    ...
    clientId: env("QODER_OAUTH_CLIENT_ID"),
    clientSecret: env("QODER_OAUTH_CLIENT_SECRET"),
